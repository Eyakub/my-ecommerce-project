...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField(
        ...
        default=True,
        help_text=ugettext_lazy('Designates whether this user would be treated as active. Unselect this instead of deleting account')
    )
...
def save_profile(sender, instance, **kwargs):
    instance.profile.save()     # (profile) this should be like related_name of one-to-one field